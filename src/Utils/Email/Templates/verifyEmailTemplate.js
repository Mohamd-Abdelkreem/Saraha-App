export const verifyEmailTemplate = ({ firstName, otp = '12345' }) => {
  return `
          <!DOCTYPE html>
          <html lang="en">
          <head>
            ...
            <title>Email Confirmation - Saraha</title>
          </head>
                    ...
                    <tr>
                      <td style="padding: 40px 30px;">
                        ...
                        <p style="margin: 0 0 25px; color: #4a5568; font-size: 16px; line-height: 1.6;">
                          Thank you for joining Saraha! We're excited to have you on board. To complete your registration and start receiving anonymous messages, please confirm your email address using the verification code below.
                        </p>
                        ...
                        <div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px 20px; border-radius: 4px; margin: 25px 0;">
                          <p style="margin: 0; color: #856404; font-size: 14px; line-height: 1.5;">
                            ⏰ <strong>Important:</strong> This verification code will expire in <strong>10 minutes</strong>. Please use it promptly to confirm your account.
                          </p>
                        </div>
                        
                        <p style="margin: 25px 0 0; color: #718096; font-size: 14px; line-height: 1.6;">
                          If you didn't create an account with Saraha, you can safely ignore this email. No further action is required.
                        </p>
                      </td>
                    </tr>
